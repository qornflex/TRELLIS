 ...
 * @param trivecs 		    Pointer to the trivectors of octree nodes
 * @param trivec_rank 	    Integer containing the rank of the trivectors
 * @param trivec_dim 	    Integer containing the dimension of the trivectors
 ...
 * @param out_percent_depth  Pointer to the output percent depth
 * 
